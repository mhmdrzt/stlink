...
#define FLASH_REGS_ADDR_AT FLASH_REGS_ADDR
#define FLASH_PSR_AT (FLASH_REGS_ADDR_AT + 0x00)
#define FLASH_UNLOCK_AT (FLASH_REGS_ADDR_AT + 0x04)
#define FLASH_USD_UNLOCK_AT (FLASH_REGS_ADDR_AT + 0x08)
#define FLASH_STS_AT (FLASH_REGS_ADDR_AT + 0x0C)
#define FLASH_CTRL_AT (FLASH_REGS_ADDR_AT + 0x10)
#define FLASH_ADDR_AT (FLASH_REGS_ADDR_AT + 0x14)
#define FLASH_USD_AT (FLASH_REGS_ADDR_AT + 0x1C)
#define FLASH_EPPS_AT (FLASH_REGS_ADDR_AT + 0x20)
#define FLASH_UNLOCK2_AT (FLASH_REGS_ADDR_AT + 0x44)
#define FLASH_STS2_AT (FLASH_REGS_ADDR_AT + 0x4C)
#define FLASH_CTRL2_AT (FLASH_REGS_ADDR_AT + 0x50)
#define FLASH_ADDR2_AT (FLASH_REGS_ADDR_AT + 0x54)
#define FLASH_UNLOCK3_AT (FLASH_REGS_ADDR_AT + 0x84)
#define FLASH_SELECT_AT (FLASH_REGS_ADDR_AT + 0x88)
#define FLASH_STS3_AT (FLASH_REGS_ADDR_AT + 0x8C)
#define FLASH_CTRL3_AT (FLASH_REGS_ADDR_AT + 0x90)
#define FLASH_ADDR3_AT (FLASH_REGS_ADDR_AT + 0x94)
#define FLASH_DA_AT (FLASH_REGS_ADDR_AT + 0x98)
#define SLIB_STS0_AT (FLASH_REGS_ADDR_AT + 0xCC)
#define SLIB_STS1_AT (FLASH_REGS_ADDR_AT + 0xD0)
#define SLIB_PWD_CLR_AT (FLASH_REGS_ADDR_AT + 0xD4)
#define SLIB_MISC_STS_AT (FLASH_REGS_ADDR_AT + 0xD8)
#define SLIB_SET_PWD_AT (FLASH_REGS_ADDR_AT + 0xDC)
#define SLIB_SET_RANGE_AT (FLASH_REGS_ADDR_AT + 0xE0)
#define SLIB_UNLOCK_AT (FLASH_REGS_ADDR_AT + 0xF0)
#define FLASH_CRC_CTRL_AT (FLASH_REGS_ADDR_AT + 0xF4)
#define FLASH_CRC_CHKR_AT (FLASH_REGS_ADDR_AT + 0xF8)
#pragma endregion
