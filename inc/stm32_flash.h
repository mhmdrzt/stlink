...
#pragma region ArteryTech
#define FLASH_AT_REGS_ADDR FLASH_REGS_ADDR
#define FLASH_AT_PSR (FLASH_AT_REGS_ADDR + 0x00)
#define FLASH_AT_UNLOCK (FLASH_AT_REGS_ADDR + 0x04)
#define FLASH_AT_USD_UNLOCK (FLASH_AT_REGS_ADDR + 0x08)
#define FLASH_AT_STS (FLASH_AT_REGS_ADDR + 0x0C)
#define FLASH_AT_CTRL (FLASH_AT_REGS_ADDR + 0x10)
#define FLASH_AT_ADDR (FLASH_AT_REGS_ADDR + 0x14)
#define FLASH_AT_USD (FLASH_AT_REGS_ADDR + 0x1C)
#define FLASH_AT_EPPS (FLASH_AT_REGS_ADDR + 0x20)
#define FLASH_AT_UNLOCK2 (FLASH_AT_REGS_ADDR + 0x44)
#define FLASH_AT_STS2 (FLASH_AT_REGS_ADDR + 0x4C)
#define FLASH_AT_CTRL2 (FLASH_AT_REGS_ADDR + 0x50)
#define FLASH_AT_ADDR2 (FLASH_AT_REGS_ADDR + 0x54)
#define FLASH_AT_UNLOCK3 (FLASH_AT_REGS_ADDR + 0x84)
#define FLASH_AT_SELECT (FLASH_AT_REGS_ADDR + 0x88)
#define FLASH_AT_STS3 (FLASH_AT_REGS_ADDR + 0x8C)
#define FLASH_AT_CTRL3 (FLASH_AT_REGS_ADDR + 0x90)
#define FLASH_AT_ADDR3 (FLASH_AT_REGS_ADDR + 0x94)
#define FLASH_AT_DA (FLASH_AT_REGS_ADDR + 0x98)
#define SLIB_AT_STS0 (FLASH_AT_REGS_ADDR + 0xCC)
#define SLIB_AT_STS1 (FLASH_AT_REGS_ADDR + 0xD0)
#define SLIB_AT_PWD_CLR (FLASH_AT_REGS_ADDR + 0xD4)
#define SLIB_AT_MISC_STS (FLASH_AT_REGS_ADDR + 0xD8)
#define SLIB_AT_SET_PWD (FLASH_AT_REGS_ADDR + 0xDC)
#define SLIB_AT_SET_RANGE (FLASH_AT_REGS_ADDR + 0xE0)
#define SLIB_AT_UNLOCK (FLASH_AT_REGS_ADDR + 0xF0)
#define FLASH_AT_CRC_CTRL (FLASH_AT_REGS_ADDR + 0xF4)
#define FLASH_AT_CRC_CHKR (FLASH_AT_REGS_ADDR + 0xF8)

#define STM32_AT_DBGMCU_CR 0xE0042004
#define STM32_AT_DBGMCU_WWDT_PAUSE 9
#define STM32_AT_DBGMCU_WDT_PAUSE 8
...
#pragma region ArteryTech_BIT_MASKS

// Constants
#define FLASH_AT_UNLOCK_KEY1 ((uint32_t)0x45670123) /*!< flash operation unlock order key1 */
#define FLASH_AT_UNLOCK_KEY2 ((uint32_t)0xCDEF89AB) /*!< flash operation unlock order key2 */
#define FLASH_AT_FAP_RELIEVE_KEY ((uint16_t)0x00A5)     /*!< flash fap relieve key val */
#define FLASH_AT_SLIB_UNLOCK_KEY ((uint32_t)0xA35F6D24) /*!< flash slib operation unlock order key */
#define FLASH_AT_BANK1_START_ADDR ((uint32_t)0x08000000) /*!< flash start address of bank1 */
#define FLASH_AT_BANK1_END_ADDR ((uint32_t)0x0807FFFF) /*!< flash end address of bank1 */
#define FLASH_AT_BANK2_START_ADDR ((uint32_t)0x08080000) /*!< flash start address of bank2 */
#define FLASH_AT_BANK2_END_ADDR ((uint32_t)0x080FFFFF) /*!< flash end address of bank2 */

// FLASH_STS
#define FLASH_AT_STS_OBF 0
#define FLASH_AT_STS_PRGMERR 2
#define FLASH_AT_STS_EPPERR 4
#define FLASH_AT_STS_ODF 5
#define FLASH_AT_STS_ERROR_MASK ((1 << FLASH_AT_STS_EPPERR) | (1 << FLASH_AT_STS_PRGMERR))

// FLASH_CTRL
#define FLASH_AT_CTRL_FPRGM 0
#define FLASH_AT_CTRL_SECERS 1
#define FLASH_AT_CTRL_BANKERS 2
#define FLASH_AT_CTRL_USDPRGM 4
#define FLASH_AT_CTRL_USDERS 5
#define FLASH_AT_CTRL_ERSTR 6
#define FLASH_AT_CTRL_OPLK 7
#define FLASH_AT_CTRL_USDULKS 9
#define FLASH_AT_CTRL_ERRIE 10
#define FLASH_AT_CTRL_ODFIE 12

// FLASH_USD
#define FLASH_AT_USD_USDERR 0
#define FLASH_AT_USD_FAP 1
#define FLASH_AT_USD_SSB_nWDT_ATO_EN 2
#define FLASH_AT_USD_SSB_nDEPSLP_RST 3
#define FLASH_AT_USD_SSB_nSTDBY_RST 4
#define FLASH_AT_USD_SSB_BTOPT 5
